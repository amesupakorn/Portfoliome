        ...
        {isLoading
          ...
          : projects.map((project, index) => (
            <div
              ...
              className={`bg-gradient-to-br from-zinc-900 to-gray-900 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer h-full flex flex-col`}
            ...
            >
              ...
              <div className="flex justify-between items-center mt-4">
                <span className="text-gray-400 text-sm group-hover:text-blue-500 inline-flex items-center transition-colors">
                  {project.link ? "View website" : "View project"}
                  <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                </span>
